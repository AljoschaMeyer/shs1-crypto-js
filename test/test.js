// This only tests a successful handshake with explicit test data. `npm test`
// also runs the shs integration test suite to test for correct handling of
// misbehaving peers.

const assert = require('assert');

const {
  createMsg1, verifyMsg1,
  createMsg2, verifyMsg2,
  createMsg3, verifyMsg3,
  verifyMsg4, createMsg4,
  clientOutcome, serverOutcome
} = require('../index.js');
